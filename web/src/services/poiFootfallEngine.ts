/**
 * TARA POI-Based Night Pedestrian Exposure & Footfall Engine
 *
 ...
 *
 * Formula:
 * 1. For each POI within 500m:
 *    decay = max(0, 1 - distanceMeters / 500)
 *    contribution = baseWeight * nightRetention * decay * timeOfDayFactor
 * 2. Total Raw POI Exposure = sum(contributions)
 * 3. Total Night Exposure = clamp0to100(baselineRoadConnectivity + Total Raw POI Exposure)
 * 4. Footfall Exposure Risk Factor = 100 - Total Night Exposure
 */
